...
var counter=0;
class Pet{
    constructor(payment,name,age,gender,breed,service,owner,phone){
        this.name=name;
        this.age=age;
        this.gender=gender;
        this.breed=breed;
...
//create pets
var scooby=new Pet("Cash","Scooby",60,"Male","Dane","Grooming","Shaggy","555-555-555");
saloon.pets.push(scooby);
var scrappy=new Pet("Credit","Scrappy",50,"Male","Mixed","Nails cut","Shaggy","555-555-555");
saloon.pets.push(scrappy);
var tweety=new Pet("First Born","Tweety bird",60,"male","Bird","Nails cut","Bugs Bunny","999-999-9999");
...
var txtPayment=document.getElementById(`paymentMethod`)
...
function display(){
    ...
    for(var i=0; i<saloon.pets.length;i++){
        tmp+=`<div class="pet">
                ...
                <p>Service: ${saloon.pets[i].payment} </p>
